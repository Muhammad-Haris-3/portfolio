...
import { profile, links, gmailComposeUrl } from "@/content/portfolio";
...
export function Hero() {
  ...
  const githubUrl =
    links.find((l) => l.label === "GitHub")?.href || "https://github.com";
  const linkedinUrl =
    links.find((l) => l.label === "LinkedIn")?.href || "https://linkedin.com";

  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-black px-6 relative overflow-hidden pt-24 md:pt-0"
    >
        ...
        <div className="space-y-6 text-left">
          <div className="space-y-2">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-white leading-tight tracking-tight">
              ...
              <span className="text-yellow-500 bg-gradient-to-r from-yellow-500 to-yellow-300 bg-clip-text text-transparent">
                Insights
              </span>
            </h1>
          </div>
          ...
          <div className="flex gap-4">
            <a
              ...
              className="p-3 bg-gradient-to-br from-yellow-500 to-yellow-600 text-black rounded-full hover:scale-110 transition-transform shadow-lg shadow-yellow-500/20"
              title="GitHub"
            >
